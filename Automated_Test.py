...
def combineBothWinRates(blue_input, red_input):
    ...
    return blue_win_chance,red_win_chance
...
for matches in players:
    ...
    for match in matches:
        ...
        blue_win_chance, red_win_chance = combineBothWinRates(blue_team, red_team)
        match_count += 1

        if blue_win_chance > red_win_chance and winner == "Blue":
            correct_count += 1

        if blue_win_chance > red_win_chance and winner == "Red":
            correct_count += 1

print(correct_count/match_count*100)
